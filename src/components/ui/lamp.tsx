...
export const LampContainer = ({ children, className }: LampProps) => {
  return (
    <div
      className={cn(
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 90deg at 50% 50%, hsl(263 70% 50% / 0) 50%, hsl(263 70% 50% / 1) 100%)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 270deg at 50% 50%, hsl(263 70% 50% / 0) 50%, hsl(263 70% 50% / 1) 100%)`,
          }}
